...
from src.data.dataset import TID2013
...
def main(args, cfg):
    ...
    dataset = TID2013(root_dir='../data/TID2013', img_size=(192, 192))
    ...
    with tqdm(dataloader) as tepoch:
        for iteration, (ref_imgs, dist_imgs, mos) in enumerate(tepoch):
